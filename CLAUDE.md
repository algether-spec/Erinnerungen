...
- Patch-Version bei dev-Commits mit `-dev` Suffix — Beispiel: `v1.0.51-dev`
...
- Bei jedem Commit den **Patch automatisch erhöhen** (z. B. v1.0.7 → v1.0.8)
...
- Beispiel: `fix(sync): Polling läuft immer als Fallback + v1.0.8`
